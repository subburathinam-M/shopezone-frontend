    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Force page reload to ensure all contexts update
                setTimeout(() => {
                ...
                toast.error(data.error_description || 'Invalid credentials');
            }
        } catch (error) {
            ...
            >
                ...
                <div className="relative p-5 sm:p-6 md:p-8">
                    ...
                    >
                        ...
                        <motion.h2 
                            variants={itemVariants}
                            className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mt-3 sm:mt-4"
                        >
                            Welcome Back
                        </motion.h2>
                        <motion.p 
                            variants={itemVariants}
                            className="text-white/70 mt-1 sm:mt-2 text-xs sm:text-sm md:text-base"
                        >
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    onBlur={handleBlur}
                                    className={`w-full pl-9 sm:pl-10 pr-3 py-2.5 sm:py-3 bg-white/10 border ${
                                        errors.username && touched.username
                                            ? 'border-red-400 focus:ring-red-400'
                                            : 'border-white/20 focus:ring-white'
                                    } rounded-xl focus:outline-none focus:ring-2 text-white placeholder-white/50 transition-all text-sm sm:text-base`}
                        ...
                        <motion.div variants={itemVariants} className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    className={`w-full pl-9 sm:pl-10 pr-10 py-2.5 sm:py-3 bg-white/10 border ${
                        ...
                        >
                            <label className="flex items-center space-x-2">
                                <motion.input
                                    whileTap={{ scale: 0.9 }}
                                    type="checkbox"
                                    className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded border-white/20 bg-white/10 text-indigo-500 focus:ring-indigo-500"
                                />
                        ...
                        <motion.p 
                            variants={itemVariants}
                            className="text-center text-white/70 text-xs sm:text-sm md:text-base"
                        >
                            Don't have an account?{' '}
                            <Link to="/register">
                                <motion.span
                                    className="text-white font-semibold cursor-pointer inline-block"
